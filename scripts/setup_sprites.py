...
def find_steam_sprites():
    ...
    if system == "Darwin":  # macOS
        possible_paths = [
            Path.home() / "Library/Application Support/Steam/steamapps/common/Baba Is You/Baba Is You.app/Contents/Resources/Data/Sprites",
...
def main():
    ...
    marker_file.write_text("This directory contains official Baba Is You sprites.\nDO NOT COMMIT TO GIT!")
