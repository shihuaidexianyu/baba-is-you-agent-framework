...
from baba import make, UserAgent, EpisodePlayer
...
def main():
    ...
    parser.add_argument(
        "--env",
        default="simple",
        help="Environment to record (default: simple)"
    )
    parser.add_argument(
        "--output",
        default="docs/gameplay.gif",
        help="Output GIF path (default: docs/gameplay.gif)"
    )
    parser.add_argument(
        "--cell-size",
        type=int,
    ...
    parser.add_argument(
        ...
        type=int,
        default=5,
        help="Recording FPS (default: 5)"
    )
    parser.add_argument(
        "--max-frames",
        type=int,
        default=50,
        help="Maximum frames to record (default: 50)"
    )
