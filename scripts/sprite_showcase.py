...
import numpy as np
import cv2
from baba.sprites import create_object_sprite, create_text_sprite, SPRITE_PATTERNS, TEXT_PATTERNS
...
def create_showcase_image():
    ...
    cv2.putText(canvas, "Baba Is You - Sprite Showcase", (20, 40), 
                font, 1.2, (255, 255, 255), 2)
    
    # Draw objects
    cv2.putText(canvas, "Game Objects:", (20, 80), 
    ...
    cv2.putText(canvas, "Text Objects:", (20, y_offset - 20), 
                font, 0.8, (200, 200, 200), 1)
